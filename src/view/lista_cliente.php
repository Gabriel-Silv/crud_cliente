    ...
    <script>
        $(document).ready(function() {
         ...
         function delete_cliente(id){
             ...
             $.ajax({
                url: "http://localhost/crud-clientes/src/Controller/ClienteController.php?id_cliente="+id, 
                dataType: "json",
                method: "DELETE",
         ...
         function lista_cliente(){
            ...
            $.ajax({
                url: "http://localhost/crud-clientes/src/Controller/ClienteController.php", 
                dataType: "json",
                success: function(data) {
                    // Loop pelos dados de clientes
                    $("#clientesTable").empty(); 
                    $.each( data["data"], function(index, cliente) {
                        ...
                        newRow.append("<td> <a href='#' class='edit-icon' onclick='edita_cliente("+cliente.id_cliente +")'><i class='fa fa-pencil'></i></a>&nbsp; <a href='#' onclick='delete_cliente("+cliente.id_cliente +")' class='remove-icon'><i class='fa fa-trash'></i></a> </td>"); 
